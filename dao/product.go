...
func (dao *ProductDao) CreateProduct(porduct model.Product) (err error) {
	return dao.DB.Model(&model.Product{}).Create(&porduct).Error
}
...
func (dao *ProductDao) ListProductByCoditon(condition map[string]interface{}, page model.BasePage) (products []*model.Product, err error) {
